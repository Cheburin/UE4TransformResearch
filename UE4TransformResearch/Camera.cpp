...
DirectX::XMFLOAT3 m_cameraPos = XMFLOAT3(0, 0, 100);
	...
	void CALLBACK OnFrameMove(double fTime, float fElapsedTime, void* pUserContext)
	{
		...
		auto kb = _keyboard->GetState();
		{
			...
			if (kb.NumPad1){
				...
				auto pr = DirectX::XMMatrixOrthographicLH(scene_state.vFrustumParams.w * (1700 + ZOOM), (1700 + ZOOM), scene_state.vFrustumNearFar.x, scene_state.vFrustumNearFar.y);

				DirectX::XMStoreFloat4x4(&scene_state.mProjection, DirectX::XMMatrixTranspose(pr));
			}
